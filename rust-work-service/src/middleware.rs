...
/// 2. Authorization Bearer token (for user calls)
///
/// On success, inserts an AuthenticatedUser into request extensions.
...
#[allow(dead_code)]
pub fn get_current_user(request: &Request) -> Result<AuthenticatedUser, AuthError> {
    request
        .extensions()
