              ...
              <Card>
                ...
                <CardContent className='space-y-3'>
                  ...
                  <Button
                    ...
                    disabled={
                      selectedLocations.length === 0 || isLoadingPreview
                    }
                    className='w-full'
                  >
                    {isLoadingPreview ? (
                  ...
                  <div className='flex items-start gap-2'>
                    ...
                    <div className='text-sm text-green-800 dark:text-green-200'>
                      ...
                      <ul className='mt-1 list-inside list-disc space-y-0.5'>
                        ...
                        <li>
                          System quantities from LX03 data (aggregated by
                          location + material)
                        </li>
                      </ul>
                      {selectedIndices.size < previewData.length && (
                        <p className='mt-2 text-orange-700 dark:text-orange-300'>
                          ...
                          {previewData.length - selectedIndices.size} item(s)
                          will NOT be created (unselected)
                        </p>
                      )}
                    </div>
                  </div>
