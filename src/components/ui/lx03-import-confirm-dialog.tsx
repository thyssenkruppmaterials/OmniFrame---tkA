...
interface LX03ImportConfirmDialogProps {
  isOpen: boolean
  rowCount: number
  onConfirm: () => void
  onCancel: () => void
...
export const LX03ImportConfirmDialog = React.memo(
  ({
    isOpen,
    rowCount,
    onConfirm,
          ...
          <div className='space-y-4'>
            ...
            <div className='rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20'>
              <div className='space-y-3'>
                ...
                <div className='space-y-1 text-xs text-yellow-800 dark:text-yellow-300'>
                  ...
                  <p>• All existing LX03 data will be cleared</p>
            ...
            <div className='bg-muted flex items-start gap-2 rounded-lg p-3'>
              ...
              <p className='text-muted-foreground text-sm'>
                This operation cannot be undone. Make sure you have a backup of
                your current data if needed.
              </p>
            </div>
          </div>
...
LX03ImportConfirmDialog.displayName = 'LX03ImportConfirmDialog'
