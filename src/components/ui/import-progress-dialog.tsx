...
import type { ImportProgress } from '@/lib/supabase/delivery-status.service'
...
export const ImportProgressDialog = React.memo(
  ({ isOpen, progress, onClose }: ImportProgressDialogProps) => {
    ...
    const headerContent = React.useMemo(
      () => (
        <DialogHeader>
          ...
          <DialogDescription>
            Processing {progress.totalRows.toLocaleString()} delivery records
          </DialogDescription>
        </DialogHeader>
      ),
            ...
            {isCompleted && (
              <div className='rounded-lg bg-green-50 p-3 dark:bg-green-900/20'>
                ...
                <p className='mt-1 text-xs text-green-600 dark:text-green-400'>
                  ...
                  delivery database.
                  {progress.duplicateRows > 0 &&
                    ` ${progress.duplicateRows.toLocaleString()} duplicates were skipped.`}
                </p>
              </div>
            )}
          </div>
...
ImportProgressDialog.displayName = 'ImportProgressDialog'
